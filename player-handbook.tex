...
\begin{itemize}
	...
	\item Calculate the magicka cost using the following formula: $Total Cost=0.1Base Cost*0.15Area*6Duration*Magnitude^{1.28}$
\end{itemize}

Duration is in rounds. Ask your GM for information on the base costs of effects or use the following link: \url{http://en.uesp.net/wiki/Oblivion:Spell_Effects}
