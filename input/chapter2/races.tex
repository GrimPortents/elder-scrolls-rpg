...
\begin{tabular}[h]{p{0.2\textwidth}ccccccc}
	\rowcolor{gray!50}
...
\begin{wrapfigure}{L}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/altmer.png}
\end{wrapfigure}
...
\subsection{Argonian}
\begin{wrapfigure}{L}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/argonian.png}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/bosmer.png}
\end{wrapfigure}
...
\subsection{Breton}
\begin{wrapfigure}{L}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/breton.png}
\end{wrapfigure}
...
\begin{wrapfigure}{L}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/dunmer.png}
\end{wrapfigure}
...
\subsection{Imperial}
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/imperial.png}
\end{wrapfigure}
...
\subsection{Khajiit}
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/khajiit.png}
\end{wrapfigure}
...
\subsection{Nord}
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/nord.png}
\end{wrapfigure}
...
\subsection{Orc}
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/orc.png}
\end{wrapfigure}
...
\subsection{Redguard}
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=\textwidth]{races/redguard.png}
\end{wrapfigure}
